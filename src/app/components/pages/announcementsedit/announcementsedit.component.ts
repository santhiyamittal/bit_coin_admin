...
@Component({
  selector: 'app-announcementsedit',
  templateUrl: './announcementsedit.component.html',
  styleUrls: ['./announcementsedit.component.scss']
})
export class AnnouncementseditComponent implements OnInit {
  ...
  // EndTime: string;
  date="08/06/2021"
  constructor(public dialogRef: MatDialogRef<AnnouncementseditComponent>,
