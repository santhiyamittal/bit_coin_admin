...
@Component({
  selector: 'app-editwithdraw',
  templateUrl: './editwithdraw.component.html',
  styleUrls: ['./editwithdraw.component.scss']
})
export class EditwithdrawComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<EditwithdrawComponent>,
