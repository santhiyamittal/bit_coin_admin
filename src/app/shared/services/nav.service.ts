...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    { headTitle: 'dashboard' },
    // {
    //   path: 'dashboard/dashboard', title: 'Dashboard', type: 'sub', icon: 'ti-home',
      // children: [
      //   { path: 'dashboard/dashboard', title: 'Dashboard', type: 'link' },
      //   { path: 'dashboard/userlist', title: 'User List', type: 'link' },
      //   { path: 'dashboard/adduser', title: 'Add User', type: 'link' },
      //   { path: 'dashboard/inactive', title: 'Inactive', type: 'link' },
      // ]
    ...
    // {
    //   title: 'User Page', icon: 'ion-arrow-right-b', type: 'sub', active: false,
    //   children: [
    //     { path: 'dashboard/userlist', title: 'Dashboard', type: 'link' },
    ...
    //       children: [
    //         {  path: 'dashboard/userlist',title: 'Level 1.0', type: 'link' },
